...
- `sonar.dependencyCheck.htmlReportMode` = `full` (default) / `summary` / `off` controls what is stored in SonarQube; `summary` keeps scan information and the summary table only.
